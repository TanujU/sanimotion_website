/*
 * /prothesen/finger-prothese — Finger prosthesis sub-page.
 *
 * Mirrors sanimotion.com/finger-prothese-berlin/: hero (split with photo) →
 * Prothetik im Sanimotion Sanitätshaus → Dynamische Fingerprothesen (split
 * with detail image) → Top-Service / Vor-Ort-Beratung → Was uns auszeichnet
 * (6 highlights) → contact.
 */
"use client";
...
import { getFingerProtheseContent } from "~/content/pages/finger-prothese";
...
export default function FingerProthese() {
  ...
  const c = getFingerProtheseContent(locale);
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-x-16">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-card bg-muted shadow-soft relative mx-auto aspect-square w-full max-w-lg overflow-hidden">
                <img
                  src={heroImageUrl}
                  alt="Fingerprothese aus dem Sanimotion Sanitätshaus Berlin"
      ...
      {/* Prothetik im Sanimotion Sanitätshaus */}
      <Section tone="muted">
        <Container>
      ...
      {/* Dynamische Fingerprothesen — split with detail photo */}
      <Section tone="canvas">
        <Container>
          <div className="grid items-start gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-5">
              <Reveal>
                <div className="rounded-card bg-muted shadow-soft overflow-hidden">
                  <img
                    src={detailImageUrl}
                    alt="Dynamische Fingerprothese – Naked Prosthetics aus der Sanimotion-Werkstatt in Berlin"
            ...
            <div className="lg:col-span-7">
              <Reveal>
                <Eyebrow>{c.dynamisch.eyebrow}</Eyebrow>
                <Heading
                  as="h2"
                  size="display-md"
              ...
              <div className="mt-8 space-y-6">
                {c.dynamisch.paragraphs.map((p, i) => (
                  <Reveal key={i} delay={0.05 + i * 0.05}>
                    <p className="text-body-lg text-ink-muted max-w-[60ch]">
                      {p}
                    </p>
