/*
 * /skoliose-korsett — Scoliosis brace sub-page.
 *
 ...
 */
"use client";
import type { Route } from "./+types/skoliose-korsett";
...
import { getSkolioseKorsettContent } from "~/content/pages/skoliose-korsett";
import { useLocale } from "~/i18n/locale";
import heroImageUrl from "~/images/skoliose-korsett/skoliose-korsett-hero.gif";
import detailImageUrl from "~/images/skoliose-korsett/skoliose-korsett-detail.png";

export function meta(_: Route.MetaArgs) {
  const c = getSkolioseKorsettContent("de");
  return [
    { title: c.meta.title },
...
export default function SkolioseKorsett() {
  const locale = useLocale();
  const c = getSkolioseKorsettContent(locale);
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-x-16">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-card bg-muted shadow-soft relative mx-auto aspect-square w-full max-w-lg overflow-hidden">
                <img
                  src={heroImageUrl}
                  alt="Skoliose-Korsett aus dem Sanimotion Sanitätshaus Berlin"
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="lg:col-span-7">
              ...
              <Reveal className="mt-8">
                <Button href={c.beratung.cta.href} size="md">
                  {c.beratung.cta.label}
                </Button>
              </Reveal>
            </div>
          </div>
      ...
      {/* Warum ein Korsett wichtig ist — eyebrow + heading + sub-block */}
      <Section tone="canvas">
        <Container>
          ...
          <div className="mx-auto mt-10 max-w-[60ch] space-y-6 lg:mt-12">
          ...
          <Reveal className="mx-auto mt-12 max-w-[60ch] lg:mt-16">
            <Heading as="h3" size="heading-md">
              {c.warum.sub.title}
            </Heading>
            <div className="mt-4 space-y-6">
              {c.warum.sub.paragraphs.map((p, i) => (
      ...
      {/* Sonderanfertigung — split with detail photo + CTA */}
      <Section tone="muted">
        <Container>
          <div className="grid items-start gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-5">
              <Reveal>
                <div className="rounded-card bg-muted shadow-soft overflow-hidden">
                  <img
                    src={detailImageUrl}
                    alt="Maßgefertigtes Skoliose-Korsett aus der Sanimotion-Werkstatt in Berlin-Kreuzberg"
            ...
            <div className="lg:col-span-7">
              ...
              <Reveal className="mt-8">
                <Button href={c.massanfertigung.cta.href} size="md">
                  {c.massanfertigung.cta.label}
                </Button>
              </Reveal>
            </div>
          </div>
