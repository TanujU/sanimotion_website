/*
 * /prothesen/handprothese — Hand prosthesis sub-page.
 *
 * Mirrors sanimotion.com/handprothese-berlin/: hero (split with photo) →
 * Prothesenversorgung im Sanitätshaus (split with detail image) →
 * Myoelektrische Hand- und Armprothesen (split with detail image) →
...
import { getHandprotheseContent } from "~/content/pages/handprothese";
import { useLocale } from "~/i18n/locale";
import heroImageUrl from "~/images/handprothese/handprothese-hero.jpg";
...
export default function Handprothese() {
  ...
  const c = getHandprotheseContent(locale);
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-x-16">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-card bg-muted shadow-soft relative mx-auto aspect-square w-full max-w-lg overflow-hidden">
                <img
                  src={heroImageUrl}
                  alt="Handprothese aus dem Sanimotion Sanitätshaus Berlin"
            ...
            <div className="lg:col-span-5">
              <Reveal>
                <div className="rounded-card bg-muted shadow-soft overflow-hidden">
                  <img
                    src={prothetikImageUrl}
                    alt="Maßgefertigte Handprothese – aus der Sanimotion-Werkstatt in Berlin-Kreuzberg"
      ...
      {/* Myoelektrische Prothesen — split with detail photo (mirrored layout) */}
      <Section tone="canvas">
        <Container>
          <div className="grid items-start gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="order-2 lg:order-1 lg:col-span-7">
              <Reveal>
                <Eyebrow>{c.myo.eyebrow}</Eyebrow>
                <Heading
                  as="h2"
                  size="display-md"
                  className="mt-6 max-w-[24ch] hyphens-auto break-words"
            ...
            <div className="order-1 lg:order-2 lg:col-span-5">
              <Reveal>
                <div className="rounded-card bg-muted shadow-soft overflow-hidden">
                  <img
                    src={myoImageUrl}
                    alt="Myoelektrische Handprothese – moderne Prothetik im Sanimotion Sanitätshaus Berlin"
