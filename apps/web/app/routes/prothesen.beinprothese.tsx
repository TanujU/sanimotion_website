/*
 * /prothesen/beinprothese — Leg prosthesis sub-page.
 *
 ...
 * service highlights → Sanimotion-Prothesenversorgung → contact.
 */
"use client";
import type { Route } from "./+types/prothesen.beinprothese";
...
import { getBeinprotheseContent } from "~/content/pages/beinprothese";
import { useLocale } from "~/i18n/locale";
import heroImageUrl from "~/images/beinprothese/beinprothese-hero.png";
import detailImageUrl from "~/images/beinprothese/beinprothese-detail.png";

export function meta() {
  const c = getBeinprotheseContent("de");
  return buildMeta({ title: c.meta.title, description: c.meta.description, path: "/prothesen/beinprothese" });
}

export default function Beinprothese() {
  const locale = useLocale();
  const c = getBeinprotheseContent(locale);
  ...
  return (
    <>
      <JsonLd schema={buildBreadcrumbSchema([
        ...
        { name: "Beinprothese", path: "/prothesen/beinprothese" },
      ])} />
      <JsonLd schema={buildMedicalDeviceSchema({ name: c.meta.title, description: c.meta.description, path: "/prothesen/beinprothese" })} />
      <Breadcrumb items={[
        { name: "Startseite", path: "/" },
        { name: "Prothesen", path: "/prothesen" },
        { name: "Beinprothese", path: "/prothesen/beinprothese" },
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-x-16">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-card bg-muted shadow-soft relative mx-auto aspect-square w-full max-w-lg overflow-hidden">
                <img
                  src={heroImageUrl}
                  alt="Beinprothese aus dem Sanimotion Sanitätshaus Berlin"
      ...
      {/* Oberschenkel- & Unterschenkelprothesen — split with detail photo */}
      <Section tone="muted">
        <Container>
            ...
            <div className="lg:col-span-5">
              <Reveal>
                <div className="rounded-card bg-muted shadow-soft overflow-hidden">
                  <img
                    src={detailImageUrl}
                    alt="Maßgefertigte Beinprothese – aus der Sanimotion-Werkstatt in Berlin-Kreuzberg"
