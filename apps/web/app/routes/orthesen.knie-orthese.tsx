/*
 * /orthesen/knie-orthese — Knee orthosis sub-page.
 *
 * Mirrors sanimotion.com/knie-orthese-berlin/: hero (split with photo) →
 * Vorkonfektionierte Knieorthesen → Sonderanfertigungen block with detail
...
import { getKnieOrtheseContent } from "~/content/pages/knie-orthese";
...
export default function KnieOrthese() {
  ...
  const c = getKnieOrtheseContent(locale);
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-x-16">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-card bg-muted shadow-soft relative mx-auto aspect-square w-full max-w-lg overflow-hidden">
                <img
                  src={heroImageUrl}
                  alt="Knieorthese aus dem Sanimotion Sanitätshaus Berlin"
            ...
            <div className="lg:col-span-5">
              <Reveal>
                <div className="rounded-card bg-muted shadow-soft overflow-hidden">
                  <img
                    src={detailImageUrl}
                    alt="Maßgefertigte Knieorthese aus der Sanimotion-Werkstatt in Berlin-Kreuzberg"
