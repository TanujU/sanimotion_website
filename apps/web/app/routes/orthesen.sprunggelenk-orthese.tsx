/*
 * /orthesen/sprunggelenk-orthese — Ankle orthosis sub-page.
 *
 ...
 * block with detail photo → Was uns auszeichnet (6 highlights) → FAQ
 * accordion → contact.
 */
"use client";
...
import { getSprunggelenkOrtheseContent } from "~/content/pages/sprunggelenk-orthese";
...
export default function SprunggelenkOrthese() {
  ...
  const c = getSprunggelenkOrtheseContent(locale);
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-x-16">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-card bg-muted shadow-soft relative mx-auto aspect-square w-full max-w-lg overflow-hidden">
                <img
                  src={heroImageUrl}
                  alt="Sprunggelenkorthese aus dem Sanimotion Sanitätshaus Berlin"
            ...
            <div className="lg:col-span-5">
              <Reveal>
                <div className="rounded-card bg-muted shadow-soft overflow-hidden">
                  <img
                    src={detailImageUrl}
                    alt="Maßgefertigte Sprunggelenkorthese aus der Sanimotion-Werkstatt in Berlin-Kreuzberg"
